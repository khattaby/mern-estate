...
const CreateListing = () => {
    ...
    const [imageUplpadError, setImageUploadError] = useState(false)
            ...
            <form className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex flex-col flex1  gap-4">
                    ...
                    <div className="flex gap-4">
                        ...
                        <button disabled={uploading} onClick={handleImageSubmit} type="button" className="p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:-80">
                            {uploading ? 'uploading' : 'Uplaod'}
                        </button>
                    </div>
                    <p className="text-red-700 text-sm">{imageUplpadError && imageUplpadError}</p>
                    {
